...
description: "A detailed overview of OCLint as static analyzer with XCode"
tags: 
  - oclint
  - static analyzer
  - xcode
...
![1. Create a new aggregate Target](XCodeNewAggregateTarget.png)

![Name the target OCLint.](XCodeNewAggregateTarget2.png)

![Add new runscript.](AddNewRunScript.png)
